    ...
    <>
      ...
      >
        ...
        <h1 className="heroTitle  inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I am <span className="heroShiny1 text-fun-pink">currently</span>{" "}
          working on
          <br />{" "}
        ...
        >
          <div
            className="cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white border-2 hidden lg:block
